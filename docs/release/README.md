...
The selected-card, Active Squad, read-only Transfer List, Transfer Market Search
Results, and empty SBC-requirements workflows are live-validated against the
English FC 26 Web App. Duplicate, pack, pick, and populated SBC-card contracts
