...
- A versioned FC 26 adapter that recognizes the English My Club Players, Active Squad, Transfer List, and empty SBC challenge screens, extracting a selected card, ordered 11/7/5 squad groups, read-only transfer detail, or mirrored visible requirement labels.
...
- [x] Live active-squad, empty SBC-requirements, and Transfer List extractors
