...
- A versioned FC 26 adapter that recognizes the English My Club Players, Active Squad, Transfer List, Transfer Market Search Results, and empty SBC challenge screens, extracting a selected card, ordered 11/7/5 squad groups, read-only market detail, or mirrored visible requirement labels.
...
The selected-card Club, Active Squad, Transfer List, Transfer Market Search Results, and empty SBC-requirements slices have been validated against the live English FC 26 Web App. Pack, pick, duplicate, and populated SBC-card contracts have deterministic synthetic coverage; their live page adapters remain release gates and are reported as unsupported instead of guessed. See [`docs/release/known-limitations.md`](docs/release/known-limitations.md).
...
- [x] Live active-squad, empty SBC-requirements, Transfer List, and Transfer Market extractors
- [ ] Live pack, pick, duplicate, and populated SBC-card extractors
